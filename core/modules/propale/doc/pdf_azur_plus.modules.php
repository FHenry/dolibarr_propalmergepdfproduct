				...
				*/
				...
				foreach($object->lines as $line) {
					...
					if (!empty($line->fk_product)) {
						...
						if (!empty($filetomerge->id) && !empty($filetomerge->file_name)) {
						
							if (! empty($conf->product->enabled)) $filetomerge_dir = $conf->product->multidir_output[$conf->entity].'/'.dol_sanitizeFileName($line->product_ref);
							elseif (! empty($conf->service->enabled)) $filetomerge_dir = $conf->service->multidir_output[$conf->entity].'/'.dol_sanitizeFileName($line->product_ref);
							
							$infile = $filetomerge_dir.'/'.$filetomerge->file_name;
